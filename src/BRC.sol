...
contract Bot is Ownable, IFlashLoanSimpleReceiver {
    ...
    IUniswapV2Pair public constant USDT_BRC_PAIR = IUniswapV2Pair(0xEd26240476f561248Ed5a7a2DDc5f498D7eCA7b1);

    ERC20 public constant USDT = ERC20(0x55d398326f99059fF775485246999027B3197955);
    ERC20 public constant BRC = ERC20(0xbcB29423ADA483eFEA287FaB056bDF698cF9f788);
        ...
        returns (bool)
    {
        ...
        swapExactTokensForTokensSupportingFeeOnTransferTokens(
            address(USDT), address(BRC), USDT.balanceOf(address(this)), address(this)
        );
        ...
        swapExactTokensForTokensSupportingFeeOnTransferTokens(
            address(BRC), address(USDT), BRC.balanceOf(address(this)), address(this)
        );
